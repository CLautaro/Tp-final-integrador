<%-- 
    Document   : login
    Created on : 30/12/2022, 05:26:06
...
<main class="container d-flex justify-content-center align-items-center bg-warning mt-3">
    ...
    <form method="POST" action="/pagIngles/usuario/loginUser" class="py-4 px-5 rounded" >
        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-auto">
                <a href="/pagIngles/views/registro.jsp" class="link-primary">Registrarme</a>
            </div>
        </div>
    </form>
</main>
