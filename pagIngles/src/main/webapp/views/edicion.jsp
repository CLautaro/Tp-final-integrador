<%-- 
    Document   : edicion
    Created on : 30/12/2022, 16:29:05
...
<%
    if (!(boolean)session.getAttribute("isLogin")){
        response.sendRedirect("/pagIngles/");
    }
...
<main class="container d-flex justify-content-center align-items-center bg-warning mt-3">
    ...
    <form method="POST" action="/pagIngles/usuario/updateUser" class="w-50 px-5 py-4 rounded" >
        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-auto">
                <a href="/pagIngles/usuario/deleteUser" class="btn btn-danger">Eliminar</a>
            </div>
            <div class="col-auto">
